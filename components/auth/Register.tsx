...
const Register: React.FC<RegisterProps> = ({ onSwitchToLogin, onSuccess }) => {
  ...
  return (
    <div className="bg-slate-800 p-6 md:p-8 rounded-xl shadow-2xl max-w-md mx-auto">
      <h2 className="text-2xl font-bold mb-6 text-slate-100">Create Account</h2>
      ...
      <div className="mt-4">
        ...
        <button
          ...
          disabled={loading}
          className="mt-4 w-full bg-white hover:bg-gray-100 disabled:bg-slate-600 disabled:cursor-not-allowed text-gray-800 font-semibold py-3 px-4 rounded-lg transition-colors flex items-center justify-center gap-2"
        >
